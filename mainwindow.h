...
//   void on_pushButton_precedent_Candidat_clicked();
   ...
   void on_pb_stock_menu_clicked();

   void on_pb_ajouter_stock_clicked();

   void on_pb_modifier_stock_clicked();

   void on_pb_del_stock_clicked();

   void on_pb_afficher_stock_clicked();

   void on_pb_search_stock_clicked();

   void on_pb_trier_stock_clicked();

   void on_pb_historique_stock_clicked();
   ...
   void on_pb_ajouter_sponsors_clicked();

   void on_pb_modifier_sponsors_clicked();

   void on_pb_supprimer_sponsors_clicked();
   ...
   void on_pb_fichehistorique_sponsors_clicked();

   void on_pb_PDF_sponsors_clicked();

   void on_pb_imprimer_sponsors_clicked();

   void on_pb_cam_sponsors_clicked();
