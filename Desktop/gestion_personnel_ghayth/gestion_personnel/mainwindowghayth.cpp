#include "mainwindowghayth.h"
#include "ui_mainwindowghayth.h"
#include "voiture.h"
#include<QString>
#include <QSqlRecord>
#include <QSqlQuery>
...
#include<QtCharts>
#include<QChartView>
MainWindowghayth::MainWindowghayth(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::MainWindowghayth)
{
    ui->setupUi(this);
...
MainWindowghayth::~MainWindowghayth()
{
    delete ui;
}

void MainWindowghayth::update_label()  //A modifier
{
...
void MainWindowghayth::on_pb_ajouter_clicked()
{bool test=false;
    int a=v.row_count();
    if(a<15)
    {QSqlQuery query;
...
void MainWindowghayth::on_pb_sup_clicked()
{Voiture v1;
bool test=false;
...
void MainWindowghayth::on_pb_modifer_clicked()
{
    bool test=false;
     QSqlQuery query;
        QString matricule=ui->matric->text();
...
void MainWindowghayth::on_combo_currentIndexChanged(const QString &arg1)
{
     Voit.getcin2((&arg1)->toInt());
}

void MainWindowghayth::on_gadour_currentTextChanged(const QString &arg1)
{if(arg1=="OPEL")
    {ui->iyadh->clear();
...
void MainWindowghayth::on_pb_archv_clicked()
{bool test,test2;
...
void MainWindowghayth::on_restaurer_clicked() //restauration de zarch vers gvoit
{
    bool test,test2;
...
void MainWindowghayth::on_tabzarch_activated(const QModelIndex &index)
...
void MainWindowghayth::on_tabvoit_activated(const QModelIndex &index)
{
...
void MainWindowghayth::on_sup_arch_clicked() //vider(all columns)
{Voiture v1;
    bool test=false;
...
void MainWindowghayth::on_sup1_arch_clicked() //kaaba bark
{
    Voiture v1;
    bool test=false;
...
void MainWindowghayth::on_trimarque_clicked()
{
...
void MainWindowghayth::on_defaut_clicked()
{
    ui->tabvoit->setModel(v.afficher());
}

void MainWindowghayth::on_pb_affecter_clicked()
{bool test,test2;
...
void MainWindowghayth::on_pb_archv_2_clicked()
{
