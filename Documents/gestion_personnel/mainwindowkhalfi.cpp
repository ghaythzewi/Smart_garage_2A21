#include "mainwindowkhalfi.h"
#include "ui_mainwindowkhalfi.h"
#include <QMessageBox>
#include "personnel.h"
...
#include<QtCharts>
#include<QChartView>
MainWindowkhalfi::MainWindowkhalfi(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::MainWindowkhalfi)
{
    ui->setupUi(this);
...
MainWindowkhalfi::~MainWindowkhalfi()
{
    delete ui;
}
//-----------------ajout----------
void MainWindowkhalfi::on_pb_ajouter_clicked()
{
...
void MainWindowkhalfi::on_pb_supprimer_clicked()
{
    personnel P1;
...
//---------------------modifier----------
void MainWindowkhalfi::on_pushButton_9_clicked()
{
    ui->tab_personnel->QTableView::setModel(P.afficher());
...
//-----------------tri
void MainWindowkhalfi::on_trinom_toggled(bool checked)
{
    if (checked == true){
...
void MainWindowkhalfi::on_tricin_toggled(bool checked)
{
    if (checked == true){
...
//-------------------statistique
void MainWindowkhalfi::on_pb_statistique_clicked()
{
